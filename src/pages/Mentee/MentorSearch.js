...
function MentorSearch() {
    ...
    return (
        <div className="row g-5 p-5">
            ...
            <div className="col-3">
                <input type="button" value="Search" className="form-control" onClick={searchMentor} />
            </div>
                            ...
                            mentorSearchList.map((data, key) => {
                                return (
                                    <tr>
                                        ...
                                        <td>{data.name}</td>
                                        <td>{data.email}</td>
                                        {data.gender ? <td>Female</td> : <td>Male</td>}
                                        <td>{data.age}</td>
                                        <td>
                                            <i>
                                        ...
                                        <td><button type="button" className="btn btn-primary" onClick={() => doRequest(data.id)}>Request</button></td>
                                    </tr>
                                );
                            })
                        }

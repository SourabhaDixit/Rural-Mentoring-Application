...
function MentorRegister() {
    ...
    const makeValidation = () => {
        if (name === "") {
            ...
            isValid = false;
            setAlertMsg("Age is reguired");
        }
        else if (age <= 18) {
            isValid = false;
            setAlertMsg("Mentee age should be less than 18");
        ...
        if (isValid) {
            ...
            Axios.post('http://127.0.0.1:3001/mentorregister',
                ...
                if (response.data === "error") {
                    ...
                    alert("Your Details are sent to Admin for Verification, Check your Email for Update");
                    navigate("/");
                }
            });
        }
